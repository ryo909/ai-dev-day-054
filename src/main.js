import './style.css';
const PROFILE = {"day":"Day054","title":"Desk Checkout Tray","display_name_ja":"退勤もちもの分け","one_sentence":"退勤前に持ち帰る物と机に残す物を分けるツール","purpose_line_ja":"持ち帰る物を分けやすくするためのツールです。","use_case_line_ja":"退勤前に持つ物と置く物を迷う時に使います。","how_it_works_line_ja":"物をトレイに分けると、今夜持つ物がまとまります。","core_action":"sort","family":"desk_checkout_split","mechanic":"tray_sort","input_style":"desk_items","output_style":"checkout_trays","output_label":"ここを見ればOKです","audience_promise":"今夜持ち帰る物が一目で決まる。","publish_hook":"机上の物を分けるだけで今夜持つ物と置く物が固まり、退勤前の迷いが減る。","engine":"brief_driven","interaction_archetype":"tray_sort","page_archetype":"desk_tray","ui_variant":"desk","intro_variant":"desk_checkout","interaction_model":"sort_items_into_take_or_leave_trays","primary_layout":"desk_items_with_checkout_trays","result_presentation_style":"take_home_vs_leave_trays","palette_motif":"ワークデスクサンド","main_cta":"退勤前の机で試す","input_panel_title":"持ち帰る / 置くを分ける","sample_panel_title":"退勤前の机で試す","guide_panel_title":"持ち帰りの見どころ","hero_panel_label":"今夜持つ物","output_shape":"desk_tray","state_model":"tray_sort_state","core_loop":"desk_items -> tray_sort -> checkout_trays","component_pack":"desk_tray+checkout_trays","scaffold_id":"brief_canvas","single_shot_text_generator":false};
